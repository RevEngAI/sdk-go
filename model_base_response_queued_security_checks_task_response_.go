...
// checks if the BaseResponseQueuedSecurityChecksTaskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseQueuedSecurityChecksTaskResponse{}

// BaseResponseQueuedSecurityChecksTaskResponse struct for BaseResponseQueuedSecurityChecksTaskResponse
type BaseResponseQueuedSecurityChecksTaskResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableQueuedSecurityChecksTaskResponse `json:"data,omitempty"`
...
func NewBaseResponseQueuedSecurityChecksTaskResponse() *BaseResponseQueuedSecurityChecksTaskResponse {
	this := BaseResponseQueuedSecurityChecksTaskResponse{}
...
func (o *BaseResponseQueuedSecurityChecksTaskResponse) GetData() QueuedSecurityChecksTaskResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret QueuedSecurityChecksTaskResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableQueuedSecurityChecksTaskResponse and assigns it to the Data field.
func (o *BaseResponseQueuedSecurityChecksTaskResponse) SetData(v QueuedSecurityChecksTaskResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseQueuedSecurityChecksTaskResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseQueuedSecurityChecksTaskResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseQueuedSecurityChecksTaskResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseQueuedSecurityChecksTaskResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBaseResponseQueuedSecurityChecksTaskResponse struct {
	value *BaseResponseQueuedSecurityChecksTaskResponse
	isSet bool
}

func (v NullableBaseResponseQueuedSecurityChecksTaskResponse) Get() *BaseResponseQueuedSecurityChecksTaskResponse {
	return v.value
}

func (v *NullableBaseResponseQueuedSecurityChecksTaskResponse) Set(val *BaseResponseQueuedSecurityChecksTaskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseQueuedSecurityChecksTaskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseQueuedSecurityChecksTaskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseQueuedSecurityChecksTaskResponse(val *BaseResponseQueuedSecurityChecksTaskResponse) *NullableBaseResponseQueuedSecurityChecksTaskResponse {
	return &NullableBaseResponseQueuedSecurityChecksTaskResponse{value: val, isSet: true}
}

func (v NullableBaseResponseQueuedSecurityChecksTaskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseQueuedSecurityChecksTaskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
