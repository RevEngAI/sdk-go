...
`func (o *FunctionDataType) SetSourceAnalysisId(v int64)`

SetSourceAnalysisId sets SourceAnalysisId field to given value.

### HasSourceAnalysisId

`func (o *FunctionDataType) HasSourceAnalysisId() bool`
