...
`func (o *SseEventRunErrorData) GetSourceRunId() string`

GetSourceRunId returns the SourceRunId field if non-nil, zero value otherwise.

### GetSourceRunIdOk

`func (o *SseEventRunErrorData) GetSourceRunIdOk() (*string, bool)`
...
`func (o *SseEventRunErrorData) SetSourceRunId(v string)`

SetSourceRunId sets SourceRunId field to given value.

### HasSourceRunId

`func (o *SseEventRunErrorData) HasSourceRunId() bool`
