...
**SecurityScan** | Pointer to [**[]SecurityFinding**](SecurityFinding.md) | Shaped semgrep findings, one per result | [optional] 
...
`func (o *SecurityScanResult) SetSecurityScanNil(b bool)`

 SetSecurityScanNil sets the value for SecurityScan to be an explicit nil

### UnsetSecurityScan
`func (o *SecurityScanResult) UnsetSecurityScan()`

UnsetSecurityScan ensures that no value is present for SecurityScan, not even an explicit nil
### GetTotal
