...
`func (o *EnumDataType) SetSourceAnalysisId(v int64)`

SetSourceAnalysisId sets SourceAnalysisId field to given value.

### HasSourceAnalysisId

`func (o *EnumDataType) HasSourceAnalysisId() bool`
