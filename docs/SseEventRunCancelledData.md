...
`func (o *SseEventRunCancelledData) GetSourceRunId() string`

GetSourceRunId returns the SourceRunId field if non-nil, zero value otherwise.

### GetSourceRunIdOk

`func (o *SseEventRunCancelledData) GetSourceRunIdOk() (*string, bool)`
...
`func (o *SseEventRunCancelledData) SetSourceRunId(v string)`

SetSourceRunId sets SourceRunId field to given value.

### HasSourceRunId

`func (o *SseEventRunCancelledData) HasSourceRunId() bool`
