...
`func NewCalleeFunctionInfo(calleeName string, calleeVaddr string, dashboardUrl NullableString, functionId int64, matchedFunctionId NullableInt32, ) *CalleeFunctionInfo`
