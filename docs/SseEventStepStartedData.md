...
`func (o *SseEventStepStartedData) GetSourceRunId() string`

GetSourceRunId returns the SourceRunId field if non-nil, zero value otherwise.

### GetSourceRunIdOk

`func (o *SseEventStepStartedData) GetSourceRunIdOk() (*string, bool)`
...
`func (o *SseEventStepStartedData) SetSourceRunId(v string)`

SetSourceRunId sets SourceRunId field to given value.

### HasSourceRunId

`func (o *SseEventStepStartedData) HasSourceRunId() bool`
