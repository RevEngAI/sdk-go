...
type _BaseResponseProcessTree BaseResponseProcessTree
...
func (o *BaseResponseProcessTree) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseProcessTree := _BaseResponseProcessTree{}

	err = json.Unmarshal(data, &varBaseResponseProcessTree)

	if err != nil {
		return err
	}

	*o = BaseResponseProcessTree(varBaseResponseProcessTree)
