...
type _BaseResponseAnalysisDetailResponse BaseResponseAnalysisDetailResponse
...
func (o *BaseResponseAnalysisDetailResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisDetailResponse := _BaseResponseAnalysisDetailResponse{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisDetailResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisDetailResponse(varBaseResponseAnalysisDetailResponse)
