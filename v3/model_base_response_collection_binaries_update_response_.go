...
type _BaseResponseCollectionBinariesUpdateResponse BaseResponseCollectionBinariesUpdateResponse
...
func (o *BaseResponseCollectionBinariesUpdateResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseCollectionBinariesUpdateResponse := _BaseResponseCollectionBinariesUpdateResponse{}

	err = json.Unmarshal(data, &varBaseResponseCollectionBinariesUpdateResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseCollectionBinariesUpdateResponse(varBaseResponseCollectionBinariesUpdateResponse)
