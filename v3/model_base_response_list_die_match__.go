...
type _BaseResponseListDieMatch BaseResponseListDieMatch
...
func (o *BaseResponseListDieMatch) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseListDieMatch := _BaseResponseListDieMatch{}

	err = json.Unmarshal(data, &varBaseResponseListDieMatch)

	if err != nil {
		return err
	}

	*o = BaseResponseListDieMatch(varBaseResponseListDieMatch)
