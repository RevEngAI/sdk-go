...
type _BaseResponseCollectionResponse BaseResponseCollectionResponse
...
func (o *BaseResponseCollectionResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseCollectionResponse := _BaseResponseCollectionResponse{}

	err = json.Unmarshal(data, &varBaseResponseCollectionResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseCollectionResponse(varBaseResponseCollectionResponse)
