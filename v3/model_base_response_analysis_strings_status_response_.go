...
// checks if the BaseResponseAnalysisStringsStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseAnalysisStringsStatusResponse{}

// BaseResponseAnalysisStringsStatusResponse struct for BaseResponseAnalysisStringsStatusResponse
type BaseResponseAnalysisStringsStatusResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableAnalysisStringsStatusResponse `json:"data,omitempty"`
...
type _BaseResponseAnalysisStringsStatusResponse BaseResponseAnalysisStringsStatusResponse
...
func NewBaseResponseAnalysisStringsStatusResponse() *BaseResponseAnalysisStringsStatusResponse {
	this := BaseResponseAnalysisStringsStatusResponse{}
...
func (o *BaseResponseAnalysisStringsStatusResponse) GetData() AnalysisStringsStatusResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret AnalysisStringsStatusResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableAnalysisStringsStatusResponse and assigns it to the Data field.
func (o *BaseResponseAnalysisStringsStatusResponse) SetData(v AnalysisStringsStatusResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseAnalysisStringsStatusResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseAnalysisStringsStatusResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseAnalysisStringsStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseAnalysisStringsStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseAnalysisStringsStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisStringsStatusResponse := _BaseResponseAnalysisStringsStatusResponse{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisStringsStatusResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisStringsStatusResponse(varBaseResponseAnalysisStringsStatusResponse)
...
type NullableBaseResponseAnalysisStringsStatusResponse struct {
	value *BaseResponseAnalysisStringsStatusResponse
	isSet bool
}

func (v NullableBaseResponseAnalysisStringsStatusResponse) Get() *BaseResponseAnalysisStringsStatusResponse {
	return v.value
}

func (v *NullableBaseResponseAnalysisStringsStatusResponse) Set(val *BaseResponseAnalysisStringsStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseAnalysisStringsStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseAnalysisStringsStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseAnalysisStringsStatusResponse(val *BaseResponseAnalysisStringsStatusResponse) *NullableBaseResponseAnalysisStringsStatusResponse {
	return &NullableBaseResponseAnalysisStringsStatusResponse{value: val, isSet: true}
}

func (v NullableBaseResponseAnalysisStringsStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseAnalysisStringsStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
