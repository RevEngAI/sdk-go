...
// checks if the BaseResponseCollectionSearchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseCollectionSearchResponse{}

// BaseResponseCollectionSearchResponse struct for BaseResponseCollectionSearchResponse
type BaseResponseCollectionSearchResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableCollectionSearchResponse `json:"data,omitempty"`
...
type _BaseResponseCollectionSearchResponse BaseResponseCollectionSearchResponse
...
func NewBaseResponseCollectionSearchResponse() *BaseResponseCollectionSearchResponse {
	this := BaseResponseCollectionSearchResponse{}
...
func (o *BaseResponseCollectionSearchResponse) GetData() CollectionSearchResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret CollectionSearchResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableCollectionSearchResponse and assigns it to the Data field.
func (o *BaseResponseCollectionSearchResponse) SetData(v CollectionSearchResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseCollectionSearchResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseCollectionSearchResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseCollectionSearchResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseCollectionSearchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseCollectionSearchResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseCollectionSearchResponse := _BaseResponseCollectionSearchResponse{}

	err = json.Unmarshal(data, &varBaseResponseCollectionSearchResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseCollectionSearchResponse(varBaseResponseCollectionSearchResponse)
...
type NullableBaseResponseCollectionSearchResponse struct {
	value *BaseResponseCollectionSearchResponse
	isSet bool
}

func (v NullableBaseResponseCollectionSearchResponse) Get() *BaseResponseCollectionSearchResponse {
	return v.value
}

func (v *NullableBaseResponseCollectionSearchResponse) Set(val *BaseResponseCollectionSearchResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseCollectionSearchResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseCollectionSearchResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseCollectionSearchResponse(val *BaseResponseCollectionSearchResponse) *NullableBaseResponseCollectionSearchResponse {
	return &NullableBaseResponseCollectionSearchResponse{value: val, isSet: true}
}

func (v NullableBaseResponseCollectionSearchResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseCollectionSearchResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
