...
// checks if the BaseResponseStr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseStr{}

// BaseResponseStr struct for BaseResponseStr
type BaseResponseStr struct {
...
type _BaseResponseStr BaseResponseStr
...
func (o *BaseResponseStr) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseStr) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseStr) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseStr) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseStr) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseStr := _BaseResponseStr{}

	err = json.Unmarshal(data, &varBaseResponseStr)

	if err != nil {
		return err
	}

	*o = BaseResponseStr(varBaseResponseStr)
...
type NullableBaseResponseStr struct {
	value *BaseResponseStr
	isSet bool
}

func (v NullableBaseResponseStr) Get() *BaseResponseStr {
	return v.value
}

func (v *NullableBaseResponseStr) Set(val *BaseResponseStr) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseStr) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseStr) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseStr(val *BaseResponseStr) *NullableBaseResponseStr {
	return &NullableBaseResponseStr{value: val, isSet: true}
}

func (v NullableBaseResponseStr) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseStr) UnmarshalJSON(src []byte) error {
	v.isSet = true
