...
// checks if the BaseResponseDynamicExecutionStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseDynamicExecutionStatus{}

// BaseResponseDynamicExecutionStatus struct for BaseResponseDynamicExecutionStatus
type BaseResponseDynamicExecutionStatus struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableAppServicesDynamicExecutionSchemasDynamicExecutionStatus `json:"data,omitempty"`
...
type _BaseResponseDynamicExecutionStatus BaseResponseDynamicExecutionStatus
...
func NewBaseResponseDynamicExecutionStatus() *BaseResponseDynamicExecutionStatus {
	this := BaseResponseDynamicExecutionStatus{}
...
func (o *BaseResponseDynamicExecutionStatus) GetData() AppServicesDynamicExecutionSchemasDynamicExecutionStatus {
	if o == nil || IsNil(o.Data.Get()) {
		var ret AppServicesDynamicExecutionSchemasDynamicExecutionStatus
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableAppServicesDynamicExecutionSchemasDynamicExecutionStatus and assigns it to the Data field.
func (o *BaseResponseDynamicExecutionStatus) SetData(v AppServicesDynamicExecutionSchemasDynamicExecutionStatus) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseDynamicExecutionStatus) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseDynamicExecutionStatus) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseDynamicExecutionStatus) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseDynamicExecutionStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseDynamicExecutionStatus) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseDynamicExecutionStatus := _BaseResponseDynamicExecutionStatus{}

	err = json.Unmarshal(data, &varBaseResponseDynamicExecutionStatus)

	if err != nil {
		return err
	}

	*o = BaseResponseDynamicExecutionStatus(varBaseResponseDynamicExecutionStatus)
...
type NullableBaseResponseDynamicExecutionStatus struct {
	value *BaseResponseDynamicExecutionStatus
	isSet bool
}

func (v NullableBaseResponseDynamicExecutionStatus) Get() *BaseResponseDynamicExecutionStatus {
	return v.value
}

func (v *NullableBaseResponseDynamicExecutionStatus) Set(val *BaseResponseDynamicExecutionStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseDynamicExecutionStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseDynamicExecutionStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseDynamicExecutionStatus(val *BaseResponseDynamicExecutionStatus) *NullableBaseResponseDynamicExecutionStatus {
	return &NullableBaseResponseDynamicExecutionStatus{value: val, isSet: true}
}

func (v NullableBaseResponseDynamicExecutionStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseDynamicExecutionStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
