...
// checks if the BaseResponseFunctionTaskResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseFunctionTaskResponse{}

// BaseResponseFunctionTaskResponse struct for BaseResponseFunctionTaskResponse
type BaseResponseFunctionTaskResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableFunctionTaskResponse `json:"data,omitempty"`
...
type _BaseResponseFunctionTaskResponse BaseResponseFunctionTaskResponse
...
func NewBaseResponseFunctionTaskResponse() *BaseResponseFunctionTaskResponse {
	this := BaseResponseFunctionTaskResponse{}
...
// SetData gets a reference to the given NullableFunctionTaskResponse and assigns it to the Data field.
func (o *BaseResponseFunctionTaskResponse) SetData(v FunctionTaskResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseFunctionTaskResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseFunctionTaskResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseFunctionTaskResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseFunctionTaskResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseFunctionTaskResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseFunctionTaskResponse := _BaseResponseFunctionTaskResponse{}

	err = json.Unmarshal(data, &varBaseResponseFunctionTaskResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseFunctionTaskResponse(varBaseResponseFunctionTaskResponse)
...
type NullableBaseResponseFunctionTaskResponse struct {
	value *BaseResponseFunctionTaskResponse
	isSet bool
}

func (v NullableBaseResponseFunctionTaskResponse) Get() *BaseResponseFunctionTaskResponse {
	return v.value
}

func (v *NullableBaseResponseFunctionTaskResponse) Set(val *BaseResponseFunctionTaskResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseFunctionTaskResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseFunctionTaskResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseFunctionTaskResponse(val *BaseResponseFunctionTaskResponse) *NullableBaseResponseFunctionTaskResponse {
	return &NullableBaseResponseFunctionTaskResponse{value: val, isSet: true}
}

func (v NullableBaseResponseFunctionTaskResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseFunctionTaskResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
