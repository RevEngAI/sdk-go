...
// checks if the BaseResponsePipelineStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponsePipelineStatusResponse{}

// BaseResponsePipelineStatusResponse struct for BaseResponsePipelineStatusResponse
type BaseResponsePipelineStatusResponse struct {
	Data NullablePipelineStatusResponse `json:"data,omitempty"`
...
type _BaseResponsePipelineStatusResponse BaseResponsePipelineStatusResponse
...
func NewBaseResponsePipelineStatusResponse() *BaseResponsePipelineStatusResponse {
	this := BaseResponsePipelineStatusResponse{}
...
func (o *BaseResponsePipelineStatusResponse) GetData() PipelineStatusResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret PipelineStatusResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullablePipelineStatusResponse and assigns it to the Data field.
func (o *BaseResponsePipelineStatusResponse) SetData(v PipelineStatusResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponsePipelineStatusResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponsePipelineStatusResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponsePipelineStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponsePipelineStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponsePipelineStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponsePipelineStatusResponse := _BaseResponsePipelineStatusResponse{}

	err = json.Unmarshal(data, &varBaseResponsePipelineStatusResponse)

	if err != nil {
		return err
	}

	*o = BaseResponsePipelineStatusResponse(varBaseResponsePipelineStatusResponse)
...
type NullableBaseResponsePipelineStatusResponse struct {
	value *BaseResponsePipelineStatusResponse
	isSet bool
}

func (v NullableBaseResponsePipelineStatusResponse) Get() *BaseResponsePipelineStatusResponse {
	return v.value
}

func (v *NullableBaseResponsePipelineStatusResponse) Set(val *BaseResponsePipelineStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponsePipelineStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponsePipelineStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponsePipelineStatusResponse(val *BaseResponsePipelineStatusResponse) *NullableBaseResponsePipelineStatusResponse {
	return &NullableBaseResponsePipelineStatusResponse{value: val, isSet: true}
}

func (v NullableBaseResponsePipelineStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponsePipelineStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
