...
// checks if the BaseResponseReportAnalysisResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseReportAnalysisResponse{}

// BaseResponseReportAnalysisResponse struct for BaseResponseReportAnalysisResponse
type BaseResponseReportAnalysisResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableReportAnalysisResponse `json:"data,omitempty"`
...
type _BaseResponseReportAnalysisResponse BaseResponseReportAnalysisResponse
...
func NewBaseResponseReportAnalysisResponse() *BaseResponseReportAnalysisResponse {
	this := BaseResponseReportAnalysisResponse{}
...
func (o *BaseResponseReportAnalysisResponse) GetData() ReportAnalysisResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret ReportAnalysisResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableReportAnalysisResponse and assigns it to the Data field.
func (o *BaseResponseReportAnalysisResponse) SetData(v ReportAnalysisResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseReportAnalysisResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseReportAnalysisResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseReportAnalysisResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseReportAnalysisResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseReportAnalysisResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseReportAnalysisResponse := _BaseResponseReportAnalysisResponse{}

	err = json.Unmarshal(data, &varBaseResponseReportAnalysisResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseReportAnalysisResponse(varBaseResponseReportAnalysisResponse)
...
type NullableBaseResponseReportAnalysisResponse struct {
	value *BaseResponseReportAnalysisResponse
	isSet bool
}

func (v NullableBaseResponseReportAnalysisResponse) Get() *BaseResponseReportAnalysisResponse {
	return v.value
}

func (v *NullableBaseResponseReportAnalysisResponse) Set(val *BaseResponseReportAnalysisResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseReportAnalysisResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseReportAnalysisResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseReportAnalysisResponse(val *BaseResponseReportAnalysisResponse) *NullableBaseResponseReportAnalysisResponse {
	return &NullableBaseResponseReportAnalysisResponse{value: val, isSet: true}
}

func (v NullableBaseResponseReportAnalysisResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseReportAnalysisResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
