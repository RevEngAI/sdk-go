...
type _BaseResponseModelsResponse BaseResponseModelsResponse
...
func (o *BaseResponseModelsResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseModelsResponse := _BaseResponseModelsResponse{}

	err = json.Unmarshal(data, &varBaseResponseModelsResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseModelsResponse(varBaseResponseModelsResponse)
