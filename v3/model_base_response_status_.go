...
// checks if the BaseResponseStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseStatus{}

// BaseResponseStatus struct for BaseResponseStatus
type BaseResponseStatus struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableStatusOutput `json:"data,omitempty"`
...
type _BaseResponseStatus BaseResponseStatus
...
// SetData gets a reference to the given NullableStatusOutput and assigns it to the Data field.
func (o *BaseResponseStatus) SetData(v StatusOutput) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseStatus) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseStatus) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseStatus) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseStatus) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseStatus) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseStatus := _BaseResponseStatus{}

	err = json.Unmarshal(data, &varBaseResponseStatus)

	if err != nil {
		return err
	}

	*o = BaseResponseStatus(varBaseResponseStatus)
...
type NullableBaseResponseStatus struct {
	value *BaseResponseStatus
	isSet bool
}

func (v NullableBaseResponseStatus) Get() *BaseResponseStatus {
	return v.value
}

func (v *NullableBaseResponseStatus) Set(val *BaseResponseStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseStatus(val *BaseResponseStatus) *NullableBaseResponseStatus {
	return &NullableBaseResponseStatus{value: val, isSet: true}
}

func (v NullableBaseResponseStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
