...
type _BaseResponseGenerateFunctionDataTypes BaseResponseGenerateFunctionDataTypes
...
func (o *BaseResponseGenerateFunctionDataTypes) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseGenerateFunctionDataTypes := _BaseResponseGenerateFunctionDataTypes{}

	err = json.Unmarshal(data, &varBaseResponseGenerateFunctionDataTypes)

	if err != nil {
		return err
	}

	*o = BaseResponseGenerateFunctionDataTypes(varBaseResponseGenerateFunctionDataTypes)
