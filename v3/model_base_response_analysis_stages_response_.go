...
// checks if the BaseResponseAnalysisStagesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseAnalysisStagesResponse{}

// BaseResponseAnalysisStagesResponse struct for BaseResponseAnalysisStagesResponse
type BaseResponseAnalysisStagesResponse struct {
	Data NullableAnalysisStagesResponse `json:"data,omitempty"`
...
type _BaseResponseAnalysisStagesResponse BaseResponseAnalysisStagesResponse
...
func NewBaseResponseAnalysisStagesResponse() *BaseResponseAnalysisStagesResponse {
	this := BaseResponseAnalysisStagesResponse{}
...
func (o *BaseResponseAnalysisStagesResponse) GetData() AnalysisStagesResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret AnalysisStagesResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableAnalysisStagesResponse and assigns it to the Data field.
func (o *BaseResponseAnalysisStagesResponse) SetData(v AnalysisStagesResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseAnalysisStagesResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseAnalysisStagesResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseAnalysisStagesResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseAnalysisStagesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseAnalysisStagesResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisStagesResponse := _BaseResponseAnalysisStagesResponse{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisStagesResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisStagesResponse(varBaseResponseAnalysisStagesResponse)
...
type NullableBaseResponseAnalysisStagesResponse struct {
	value *BaseResponseAnalysisStagesResponse
	isSet bool
}

func (v NullableBaseResponseAnalysisStagesResponse) Get() *BaseResponseAnalysisStagesResponse {
	return v.value
}

func (v *NullableBaseResponseAnalysisStagesResponse) Set(val *BaseResponseAnalysisStagesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseAnalysisStagesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseAnalysisStagesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseAnalysisStagesResponse(val *BaseResponseAnalysisStagesResponse) *NullableBaseResponseAnalysisStagesResponse {
	return &NullableBaseResponseAnalysisStagesResponse{value: val, isSet: true}
}

func (v NullableBaseResponseAnalysisStagesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseAnalysisStagesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
