...
// checks if the BaseResponseRecent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseRecent{}

// BaseResponseRecent struct for BaseResponseRecent
type BaseResponseRecent struct {
	Data NullableRecent `json:"data,omitempty"`
...
type _BaseResponseRecent BaseResponseRecent
...
// SetData gets a reference to the given NullableRecent and assigns it to the Data field.
func (o *BaseResponseRecent) SetData(v Recent) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseRecent) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseRecent) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseRecent) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseRecent) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseRecent) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseRecent := _BaseResponseRecent{}

	err = json.Unmarshal(data, &varBaseResponseRecent)

	if err != nil {
		return err
	}

	*o = BaseResponseRecent(varBaseResponseRecent)
...
type NullableBaseResponseRecent struct {
	value *BaseResponseRecent
	isSet bool
}

func (v NullableBaseResponseRecent) Get() *BaseResponseRecent {
	return v.value
}

func (v *NullableBaseResponseRecent) Set(val *BaseResponseRecent) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseRecent) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseRecent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseRecent(val *BaseResponseRecent) *NullableBaseResponseRecent {
	return &NullableBaseResponseRecent{value: val, isSet: true}
}

func (v NullableBaseResponseRecent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseRecent) UnmarshalJSON(src []byte) error {
	v.isSet = true
