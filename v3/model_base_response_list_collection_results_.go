...
type _BaseResponseListCollectionResults BaseResponseListCollectionResults
...
func (o *BaseResponseListCollectionResults) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseListCollectionResults := _BaseResponseListCollectionResults{}

	err = json.Unmarshal(data, &varBaseResponseListCollectionResults)

	if err != nil {
		return err
	}

	*o = BaseResponseListCollectionResults(varBaseResponseListCollectionResults)
