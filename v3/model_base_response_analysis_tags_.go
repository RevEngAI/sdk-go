...
// checks if the BaseResponseAnalysisTags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseAnalysisTags{}

// BaseResponseAnalysisTags struct for BaseResponseAnalysisTags
type BaseResponseAnalysisTags struct {
	Data NullableAnalysisTags `json:"data,omitempty"`
...
type _BaseResponseAnalysisTags BaseResponseAnalysisTags
...
// SetData gets a reference to the given NullableAnalysisTags and assigns it to the Data field.
func (o *BaseResponseAnalysisTags) SetData(v AnalysisTags) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseAnalysisTags) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseAnalysisTags) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseAnalysisTags) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseAnalysisTags) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseAnalysisTags) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisTags := _BaseResponseAnalysisTags{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisTags)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisTags(varBaseResponseAnalysisTags)
...
type NullableBaseResponseAnalysisTags struct {
	value *BaseResponseAnalysisTags
	isSet bool
}

func (v NullableBaseResponseAnalysisTags) Get() *BaseResponseAnalysisTags {
	return v.value
}

func (v *NullableBaseResponseAnalysisTags) Set(val *BaseResponseAnalysisTags) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseAnalysisTags) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseAnalysisTags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseAnalysisTags(val *BaseResponseAnalysisTags) *NullableBaseResponseAnalysisTags {
	return &NullableBaseResponseAnalysisTags{value: val, isSet: true}
}

func (v NullableBaseResponseAnalysisTags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseAnalysisTags) UnmarshalJSON(src []byte) error {
	v.isSet = true
