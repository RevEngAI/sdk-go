...
// checks if the FunctionTypeInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FunctionTypeInput{}

// FunctionTypeInput struct for FunctionTypeInput
type FunctionTypeInput struct {
...
type _FunctionTypeInput FunctionTypeInput
...
func (o *FunctionTypeInput) SetLastChangeNil() {
...
func (o FunctionTypeInput) MarshalJSON() ([]byte, error) {
...
func (o FunctionTypeInput) ToMap() (map[string]interface{}, error) {
...
func (o *FunctionTypeInput) UnmarshalJSON(data []byte) (err error) {
	...
	varFunctionTypeInput := _FunctionTypeInput{}

	err = json.Unmarshal(data, &varFunctionTypeInput)

	if err != nil {
		return err
	}

	*o = FunctionTypeInput(varFunctionTypeInput)
...
type NullableFunctionTypeInput struct {
	value *FunctionTypeInput
	isSet bool
}

func (v NullableFunctionTypeInput) Get() *FunctionTypeInput {
	return v.value
}

func (v *NullableFunctionTypeInput) Set(val *FunctionTypeInput) {
	v.value = val
	v.isSet = true
}

func (v NullableFunctionTypeInput) IsSet() bool {
	return v.isSet
}

func (v *NullableFunctionTypeInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFunctionTypeInput(val *FunctionTypeInput) *NullableFunctionTypeInput {
	return &NullableFunctionTypeInput{value: val, isSet: true}
}

func (v NullableFunctionTypeInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFunctionTypeInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
