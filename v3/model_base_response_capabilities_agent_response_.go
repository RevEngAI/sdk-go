...
// checks if the BaseResponseCapabilitiesAgentResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseCapabilitiesAgentResponse{}

// BaseResponseCapabilitiesAgentResponse struct for BaseResponseCapabilitiesAgentResponse
type BaseResponseCapabilitiesAgentResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableCapabilitiesAgentResponse `json:"data,omitempty"`
...
type _BaseResponseCapabilitiesAgentResponse BaseResponseCapabilitiesAgentResponse
...
func NewBaseResponseCapabilitiesAgentResponse() *BaseResponseCapabilitiesAgentResponse {
	this := BaseResponseCapabilitiesAgentResponse{}
...
func (o *BaseResponseCapabilitiesAgentResponse) GetData() CapabilitiesAgentResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret CapabilitiesAgentResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableCapabilitiesAgentResponse and assigns it to the Data field.
func (o *BaseResponseCapabilitiesAgentResponse) SetData(v CapabilitiesAgentResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseCapabilitiesAgentResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseCapabilitiesAgentResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseCapabilitiesAgentResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseCapabilitiesAgentResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseCapabilitiesAgentResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseCapabilitiesAgentResponse := _BaseResponseCapabilitiesAgentResponse{}

	err = json.Unmarshal(data, &varBaseResponseCapabilitiesAgentResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseCapabilitiesAgentResponse(varBaseResponseCapabilitiesAgentResponse)
...
type NullableBaseResponseCapabilitiesAgentResponse struct {
	value *BaseResponseCapabilitiesAgentResponse
	isSet bool
}

func (v NullableBaseResponseCapabilitiesAgentResponse) Get() *BaseResponseCapabilitiesAgentResponse {
	return v.value
}

func (v *NullableBaseResponseCapabilitiesAgentResponse) Set(val *BaseResponseCapabilitiesAgentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseCapabilitiesAgentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseCapabilitiesAgentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseCapabilitiesAgentResponse(val *BaseResponseCapabilitiesAgentResponse) *NullableBaseResponseCapabilitiesAgentResponse {
	return &NullableBaseResponseCapabilitiesAgentResponse{value: val, isSet: true}
}

func (v NullableBaseResponseCapabilitiesAgentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseCapabilitiesAgentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
