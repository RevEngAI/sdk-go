...
type _BaseResponseConfigResponse BaseResponseConfigResponse
...
func (o *BaseResponseConfigResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseConfigResponse := _BaseResponseConfigResponse{}

	err = json.Unmarshal(data, &varBaseResponseConfigResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseConfigResponse(varBaseResponseConfigResponse)
