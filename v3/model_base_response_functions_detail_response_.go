...
type _BaseResponseFunctionsDetailResponse BaseResponseFunctionsDetailResponse
...
func (o *BaseResponseFunctionsDetailResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseFunctionsDetailResponse := _BaseResponseFunctionsDetailResponse{}

	err = json.Unmarshal(data, &varBaseResponseFunctionsDetailResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseFunctionsDetailResponse(varBaseResponseFunctionsDetailResponse)
