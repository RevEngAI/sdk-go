...
// checks if the BaseResponseProcessDumps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseProcessDumps{}

// BaseResponseProcessDumps struct for BaseResponseProcessDumps
type BaseResponseProcessDumps struct {
	Data NullableProcessDumps `json:"data,omitempty"`
...
type _BaseResponseProcessDumps BaseResponseProcessDumps
...
// SetData gets a reference to the given NullableProcessDumps and assigns it to the Data field.
func (o *BaseResponseProcessDumps) SetData(v ProcessDumps) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseProcessDumps) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseProcessDumps) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseProcessDumps) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseProcessDumps) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseProcessDumps) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseProcessDumps := _BaseResponseProcessDumps{}

	err = json.Unmarshal(data, &varBaseResponseProcessDumps)

	if err != nil {
		return err
	}

	*o = BaseResponseProcessDumps(varBaseResponseProcessDumps)
...
type NullableBaseResponseProcessDumps struct {
	value *BaseResponseProcessDumps
	isSet bool
}

func (v NullableBaseResponseProcessDumps) Get() *BaseResponseProcessDumps {
	return v.value
}

func (v *NullableBaseResponseProcessDumps) Set(val *BaseResponseProcessDumps) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseProcessDumps) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseProcessDumps) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseProcessDumps(val *BaseResponseProcessDumps) *NullableBaseResponseProcessDumps {
	return &NullableBaseResponseProcessDumps{value: val, isSet: true}
}

func (v NullableBaseResponseProcessDumps) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseProcessDumps) UnmarshalJSON(src []byte) error {
	v.isSet = true
