...
// checks if the BaseResponseAnalysisBulkAddTagsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseAnalysisBulkAddTagsResponse{}

// BaseResponseAnalysisBulkAddTagsResponse struct for BaseResponseAnalysisBulkAddTagsResponse
type BaseResponseAnalysisBulkAddTagsResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableAnalysisBulkAddTagsResponse `json:"data,omitempty"`
...
type _BaseResponseAnalysisBulkAddTagsResponse BaseResponseAnalysisBulkAddTagsResponse
...
func NewBaseResponseAnalysisBulkAddTagsResponse() *BaseResponseAnalysisBulkAddTagsResponse {
	this := BaseResponseAnalysisBulkAddTagsResponse{}
...
func (o *BaseResponseAnalysisBulkAddTagsResponse) GetData() AnalysisBulkAddTagsResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret AnalysisBulkAddTagsResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableAnalysisBulkAddTagsResponse and assigns it to the Data field.
func (o *BaseResponseAnalysisBulkAddTagsResponse) SetData(v AnalysisBulkAddTagsResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseAnalysisBulkAddTagsResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseAnalysisBulkAddTagsResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseAnalysisBulkAddTagsResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseAnalysisBulkAddTagsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseAnalysisBulkAddTagsResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisBulkAddTagsResponse := _BaseResponseAnalysisBulkAddTagsResponse{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisBulkAddTagsResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisBulkAddTagsResponse(varBaseResponseAnalysisBulkAddTagsResponse)
...
type NullableBaseResponseAnalysisBulkAddTagsResponse struct {
	value *BaseResponseAnalysisBulkAddTagsResponse
	isSet bool
}

func (v NullableBaseResponseAnalysisBulkAddTagsResponse) Get() *BaseResponseAnalysisBulkAddTagsResponse {
	return v.value
}

func (v *NullableBaseResponseAnalysisBulkAddTagsResponse) Set(val *BaseResponseAnalysisBulkAddTagsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseAnalysisBulkAddTagsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseAnalysisBulkAddTagsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseAnalysisBulkAddTagsResponse(val *BaseResponseAnalysisBulkAddTagsResponse) *NullableBaseResponseAnalysisBulkAddTagsResponse {
	return &NullableBaseResponseAnalysisBulkAddTagsResponse{value: val, isSet: true}
}

func (v NullableBaseResponseAnalysisBulkAddTagsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseAnalysisBulkAddTagsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
