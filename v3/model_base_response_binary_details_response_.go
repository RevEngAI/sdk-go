...
type _BaseResponseBinaryDetailsResponse BaseResponseBinaryDetailsResponse
...
func (o *BaseResponseBinaryDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseBinaryDetailsResponse := _BaseResponseBinaryDetailsResponse{}

	err = json.Unmarshal(data, &varBaseResponseBinaryDetailsResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseBinaryDetailsResponse(varBaseResponseBinaryDetailsResponse)
