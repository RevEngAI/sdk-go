...
// checks if the BaseResponseBasic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseBasic{}

// BaseResponseBasic struct for BaseResponseBasic
type BaseResponseBasic struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableBasic `json:"data,omitempty"`
...
// SetData gets a reference to the given NullableBasic and assigns it to the Data field.
func (o *BaseResponseBasic) SetData(v Basic) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseBasic) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseBasic) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseBasic) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseBasic) ToMap() (map[string]interface{}, error) {
...
type NullableBaseResponseBasic struct {
	value *BaseResponseBasic
	isSet bool
}

func (v NullableBaseResponseBasic) Get() *BaseResponseBasic {
	return v.value
}

func (v *NullableBaseResponseBasic) Set(val *BaseResponseBasic) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseBasic) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseBasic) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseBasic(val *BaseResponseBasic) *NullableBaseResponseBasic {
	return &NullableBaseResponseBasic{value: val, isSet: true}
}

func (v NullableBaseResponseBasic) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseBasic) UnmarshalJSON(src []byte) error {
	v.isSet = true
