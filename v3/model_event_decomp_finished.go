...
// checks if the EventDecompFinished type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventDecompFinished{}

// EventDecompFinished struct for EventDecompFinished
type EventDecompFinished struct {
	Data DecompFinishedEvent `json:"data"`
	// The event name.
...
type _EventDecompFinished EventDecompFinished
...
func (o EventDecompFinished) MarshalJSON() ([]byte, error) {
...
func (o EventDecompFinished) ToMap() (map[string]interface{}, error) {
...
func (o *EventDecompFinished) UnmarshalJSON(data []byte) (err error) {
	...
	varEventDecompFinished := _EventDecompFinished{}

	err = json.Unmarshal(data, &varEventDecompFinished)

	if err != nil {
		return err
	}

	*o = EventDecompFinished(varEventDecompFinished)
...
type NullableEventDecompFinished struct {
	value *EventDecompFinished
	isSet bool
}

func (v NullableEventDecompFinished) Get() *EventDecompFinished {
	return v.value
}

func (v *NullableEventDecompFinished) Set(val *EventDecompFinished) {
	v.value = val
	v.isSet = true
}

func (v NullableEventDecompFinished) IsSet() bool {
	return v.isSet
}

func (v *NullableEventDecompFinished) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventDecompFinished(val *EventDecompFinished) *NullableEventDecompFinished {
	return &NullableEventDecompFinished{value: val, isSet: true}
}

func (v NullableEventDecompFinished) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventDecompFinished) UnmarshalJSON(src []byte) error {
	v.isSet = true
