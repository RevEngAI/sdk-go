...
func (r ApiGetModelsRequest) Execute() (*BaseResponseModelsResponse, *http.Response, error) {
...
func (a *ModelsAPIService) GetModelsExecute(r ApiGetModelsRequest) (*BaseResponseModelsResponse, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *BaseResponseModelsResponse
	)
	...
	localVarPath := localBasePath + "/v2/models"
