...
type _BaseResponseUploadResponse BaseResponseUploadResponse
...
func (o *BaseResponseUploadResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseUploadResponse := _BaseResponseUploadResponse{}

	err = json.Unmarshal(data, &varBaseResponseUploadResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseUploadResponse(varBaseResponseUploadResponse)
