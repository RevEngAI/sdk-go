...
// checks if the BaseResponseCreated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseCreated{}

// BaseResponseCreated struct for BaseResponseCreated
type BaseResponseCreated struct {
	Data NullableCreated `json:"data,omitempty"`
...
type _BaseResponseCreated BaseResponseCreated
...
// SetData gets a reference to the given NullableCreated and assigns it to the Data field.
func (o *BaseResponseCreated) SetData(v Created) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseCreated) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseCreated) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseCreated) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseCreated) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseCreated) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseCreated := _BaseResponseCreated{}

	err = json.Unmarshal(data, &varBaseResponseCreated)

	if err != nil {
		return err
	}

	*o = BaseResponseCreated(varBaseResponseCreated)
...
type NullableBaseResponseCreated struct {
	value *BaseResponseCreated
	isSet bool
}

func (v NullableBaseResponseCreated) Get() *BaseResponseCreated {
	return v.value
}

func (v *NullableBaseResponseCreated) Set(val *BaseResponseCreated) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseCreated) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseCreated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseCreated(val *BaseResponseCreated) *NullableBaseResponseCreated {
	return &NullableBaseResponseCreated{value: val, isSet: true}
}

func (v NullableBaseResponseCreated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseCreated) UnmarshalJSON(src []byte) error {
	v.isSet = true
