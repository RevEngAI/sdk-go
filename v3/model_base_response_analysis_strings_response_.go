...
// checks if the BaseResponseAnalysisStringsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseAnalysisStringsResponse{}

// BaseResponseAnalysisStringsResponse struct for BaseResponseAnalysisStringsResponse
type BaseResponseAnalysisStringsResponse struct {
	Data NullableAnalysisStringsResponse `json:"data,omitempty"`
...
type _BaseResponseAnalysisStringsResponse BaseResponseAnalysisStringsResponse
...
func NewBaseResponseAnalysisStringsResponse() *BaseResponseAnalysisStringsResponse {
	this := BaseResponseAnalysisStringsResponse{}
...
func (o *BaseResponseAnalysisStringsResponse) GetData() AnalysisStringsResponse {
	if o == nil || IsNil(o.Data.Get()) {
		var ret AnalysisStringsResponse
		return ret
	}
	return *o.Data.Get()
}
...
// SetData gets a reference to the given NullableAnalysisStringsResponse and assigns it to the Data field.
func (o *BaseResponseAnalysisStringsResponse) SetData(v AnalysisStringsResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseAnalysisStringsResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseAnalysisStringsResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseAnalysisStringsResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseAnalysisStringsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseAnalysisStringsResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseAnalysisStringsResponse := _BaseResponseAnalysisStringsResponse{}

	err = json.Unmarshal(data, &varBaseResponseAnalysisStringsResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseAnalysisStringsResponse(varBaseResponseAnalysisStringsResponse)
...
type NullableBaseResponseAnalysisStringsResponse struct {
	value *BaseResponseAnalysisStringsResponse
	isSet bool
}

func (v NullableBaseResponseAnalysisStringsResponse) Get() *BaseResponseAnalysisStringsResponse {
	return v.value
}

func (v *NullableBaseResponseAnalysisStringsResponse) Set(val *BaseResponseAnalysisStringsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseAnalysisStringsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseAnalysisStringsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseAnalysisStringsResponse(val *BaseResponseAnalysisStringsResponse) *NullableBaseResponseAnalysisStringsResponse {
	return &NullableBaseResponseAnalysisStringsResponse{value: val, isSet: true}
}

func (v NullableBaseResponseAnalysisStringsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseAnalysisStringsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
