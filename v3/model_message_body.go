...
func NewMessageBody(message string) *MessageBody {
	this := MessageBody{}
...
func (o *MessageBody) GetMessage() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *MessageBody) GetMessageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MessageBody) SetMessage(v string) {
	o.Message = v
}
