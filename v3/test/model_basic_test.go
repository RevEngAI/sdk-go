...
func TestBasic_CreationFieldParsesRfc3339WithTimezone(t *testing.T) {
	jsonStr := `{
		"binary_id": 1,
...
func TestBasic_CreationFieldParsesRfc3339WithUtcZ(t *testing.T) {
	jsonStr := `{
		"binary_id": 1,
		"binary_name": "test.bin",
		"binary_size": 1024,
...
func TestBasic_CreationFieldParsesRfc3339WithNegativeOffset(t *testing.T) {
	jsonStr := `{
		"binary_id": 1,
		"binary_name": "test.bin",
		"binary_size": 1024,
...
func TestBasic_CreationFieldParsesRfc3339WithFractionalSecondsAndTimezone(t *testing.T) {
	jsonStr := `{
		"binary_id": 1,
		"binary_name": "test.bin",
		"binary_size": 1024,
...
func TestBasic_CreationFieldParsesRfc3339WithNanosecondPrecision(t *testing.T) {
	jsonStr := `{
		"binary_id": 1,
		"binary_name": "test.bin",
		"binary_size": 1024,
