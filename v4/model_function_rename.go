...
func NewFunctionRename(newName string, newMangledName string) *FunctionRename {
	...
	var sourceType FunctionSourceType = FUNCTIONSOURCETYPE_USER
...
// SetSourceType gets a reference to the given FunctionSourceType and assigns it to the SourceType field.
...
func (o *FunctionRename) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFunctionRename)
