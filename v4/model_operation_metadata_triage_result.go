...
// checks if the OperationMetadataTriageResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationMetadataTriageResult{}

// OperationMetadataTriageResult struct for OperationMetadataTriageResult
type OperationMetadataTriageResult struct {
	...
	Response *TriageResult `json:"response,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OperationMetadataTriageResult OperationMetadataTriageResult
...
func NewOperationMetadataTriageResult(done bool, name string) *OperationMetadataTriageResult {
	this := OperationMetadataTriageResult{}
	this.Done = done
	this.Name = name
	return &this
}
...
// SetResponse gets a reference to the given TriageResult and assigns it to the Response field.
func (o *OperationMetadataTriageResult) SetResponse(v TriageResult) {
	o.Response = &v
}

func (o OperationMetadataTriageResult) MarshalJSON() ([]byte, error) {
...
func (o OperationMetadataTriageResult) ToMap() (map[string]interface{}, error) {
...
func (o *OperationMetadataTriageResult) UnmarshalJSON(data []byte) (err error) {
	...
	varOperationMetadataTriageResult := _OperationMetadataTriageResult{}

	err = json.Unmarshal(data, &varOperationMetadataTriageResult)

	if err != nil {
		return err
	}

	*o = OperationMetadataTriageResult(varOperationMetadataTriageResult)
...
type NullableOperationMetadataTriageResult struct {
	value *OperationMetadataTriageResult
	isSet bool
}

func (v NullableOperationMetadataTriageResult) Get() *OperationMetadataTriageResult {
	return v.value
}

func (v *NullableOperationMetadataTriageResult) Set(val *OperationMetadataTriageResult) {
	v.value = val
	v.isSet = true
}

func (v NullableOperationMetadataTriageResult) IsSet() bool {
	return v.isSet
}

func (v *NullableOperationMetadataTriageResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOperationMetadataTriageResult(val *OperationMetadataTriageResult) *NullableOperationMetadataTriageResult {
	return &NullableOperationMetadataTriageResult{value: val, isSet: true}
}

func (v NullableOperationMetadataTriageResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOperationMetadataTriageResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
