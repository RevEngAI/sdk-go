...
type AnalysisBasicInfoOutputBody struct {
	...
	DetectedBinaryFormat string `json:"detected_binary_format"`
	...
	SuppliedBinaryFormat string `json:"supplied_binary_format"`
...
// GetDetectedBinaryFormat returns the DetectedBinaryFormat field value
func (o *AnalysisBasicInfoOutputBody) GetDetectedBinaryFormat() string {
	...
	return o.DetectedBinaryFormat
}

// GetDetectedBinaryFormatOk returns a tuple with the DetectedBinaryFormat field value
// and a boolean to check if the value has been set.
func (o *AnalysisBasicInfoOutputBody) GetDetectedBinaryFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DetectedBinaryFormat, true
}

// SetDetectedBinaryFormat sets field value
func (o *AnalysisBasicInfoOutputBody) SetDetectedBinaryFormat(v string) {
	o.DetectedBinaryFormat = v
}
...
// GetSuppliedBinaryFormat returns the SuppliedBinaryFormat field value
func (o *AnalysisBasicInfoOutputBody) GetSuppliedBinaryFormat() string {
	...
	return o.SuppliedBinaryFormat
}

// GetSuppliedBinaryFormatOk returns a tuple with the SuppliedBinaryFormat field value
// and a boolean to check if the value has been set.
func (o *AnalysisBasicInfoOutputBody) GetSuppliedBinaryFormatOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.SuppliedBinaryFormat, true
}

// SetSuppliedBinaryFormat sets field value
func (o *AnalysisBasicInfoOutputBody) SetSuppliedBinaryFormat(v string) {
	o.SuppliedBinaryFormat = v
}
...
func (o AnalysisBasicInfoOutputBody) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["detected_binary_format"] = o.DetectedBinaryFormat
