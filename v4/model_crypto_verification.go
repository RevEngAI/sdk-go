...
// checks if the CryptoVerification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CryptoVerification{}

// CryptoVerification struct for CryptoVerification
...
type _CryptoVerification CryptoVerification
...
func (o CryptoVerification) MarshalJSON() ([]byte, error) {
...
func (o CryptoVerification) ToMap() (map[string]interface{}, error) {
...
func (o *CryptoVerification) UnmarshalJSON(data []byte) (err error) {
	...
	varCryptoVerification := _CryptoVerification{}

	err = json.Unmarshal(data, &varCryptoVerification)

	if err != nil {
		return err
	}

	*o = CryptoVerification(varCryptoVerification)
...
type NullableCryptoVerification struct {
	value *CryptoVerification
	isSet bool
}

func (v NullableCryptoVerification) Get() *CryptoVerification {
	return v.value
}

func (v *NullableCryptoVerification) Set(val *CryptoVerification) {
	v.value = val
	v.isSet = true
}

func (v NullableCryptoVerification) IsSet() bool {
	return v.isSet
}

func (v *NullableCryptoVerification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCryptoVerification(val *CryptoVerification) *NullableCryptoVerification {
	return &NullableCryptoVerification{value: val, isSet: true}
}

func (v NullableCryptoVerification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCryptoVerification) UnmarshalJSON(src []byte) error {
	v.isSet = true
