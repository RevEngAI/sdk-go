...
// checks if the EventNamesFinished type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventNamesFinished{}

// EventNamesFinished struct for EventNamesFinished
type EventNamesFinished struct {
	Data NamesFinishedEvent `json:"data"`
	// The event name.
...
type _EventNamesFinished EventNamesFinished
...
func (o EventNamesFinished) MarshalJSON() ([]byte, error) {
...
func (o EventNamesFinished) ToMap() (map[string]interface{}, error) {
...
func (o *EventNamesFinished) UnmarshalJSON(data []byte) (err error) {
	...
	varEventNamesFinished := _EventNamesFinished{}

	err = json.Unmarshal(data, &varEventNamesFinished)

	if err != nil {
		return err
	}

	*o = EventNamesFinished(varEventNamesFinished)
...
type NullableEventNamesFinished struct {
	value *EventNamesFinished
	isSet bool
}

func (v NullableEventNamesFinished) Get() *EventNamesFinished {
	return v.value
}

func (v *NullableEventNamesFinished) Set(val *EventNamesFinished) {
	v.value = val
	v.isSet = true
}

func (v NullableEventNamesFinished) IsSet() bool {
	return v.isSet
}

func (v *NullableEventNamesFinished) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventNamesFinished(val *EventNamesFinished) *NullableEventNamesFinished {
	return &NullableEventNamesFinished{value: val, isSet: true}
}

func (v NullableEventNamesFinished) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventNamesFinished) UnmarshalJSON(src []byte) error {
	v.isSet = true
