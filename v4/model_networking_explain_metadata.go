...
// checks if the NetworkingExplainMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingExplainMetadata{}

// NetworkingExplainMetadata struct for NetworkingExplainMetadata
type NetworkingExplainMetadata struct {
...
type _NetworkingExplainMetadata NetworkingExplainMetadata
...
func NewNetworkingExplainMetadata(status string) *NetworkingExplainMetadata {
	this := NetworkingExplainMetadata{}
	this.Status = status
	return &this
}
...
func (o NetworkingExplainMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingExplainMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *NetworkingExplainMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varNetworkingExplainMetadata := _NetworkingExplainMetadata{}

	err = json.Unmarshal(data, &varNetworkingExplainMetadata)

	if err != nil {
		return err
	}

	*o = NetworkingExplainMetadata(varNetworkingExplainMetadata)
...
type NullableNetworkingExplainMetadata struct {
	value *NetworkingExplainMetadata
	isSet bool
}

func (v NullableNetworkingExplainMetadata) Get() *NetworkingExplainMetadata {
	return v.value
}

func (v *NullableNetworkingExplainMetadata) Set(val *NetworkingExplainMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingExplainMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingExplainMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingExplainMetadata(val *NetworkingExplainMetadata) *NullableNetworkingExplainMetadata {
	return &NullableNetworkingExplainMetadata{value: val, isSet: true}
}

func (v NullableNetworkingExplainMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingExplainMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
