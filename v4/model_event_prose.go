...
// checks if the EventProse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventProse{}

// EventProse struct for EventProse
type EventProse struct {
	Data ProseEvent `json:"data"`
	// The event name.
...
func (o EventProse) MarshalJSON() ([]byte, error) {
...
func (o EventProse) ToMap() (map[string]interface{}, error) {
...
func (o *EventProse) UnmarshalJSON(data []byte) (err error) {
	...
	varEventProse := _EventProse{}

	err = json.Unmarshal(data, &varEventProse)

	if err != nil {
		return err
	}

	*o = EventProse(varEventProse)
...
type NullableEventProse struct {
	value *EventProse
	isSet bool
}

func (v NullableEventProse) Get() *EventProse {
	return v.value
}

func (v *NullableEventProse) Set(val *EventProse) {
	v.value = val
	v.isSet = true
}

func (v NullableEventProse) IsSet() bool {
	return v.isSet
}

func (v *NullableEventProse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventProse(val *EventProse) *NullableEventProse {
	return &NullableEventProse{value: val, isSet: true}
}

func (v NullableEventProse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventProse) UnmarshalJSON(src []byte) error {
	v.isSet = true
