...
// checks if the EventTOOLCONFIRMATIONREQUIRED type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventTOOLCONFIRMATIONREQUIRED{}

// EventTOOLCONFIRMATIONREQUIRED struct for EventTOOLCONFIRMATIONREQUIRED
type EventTOOLCONFIRMATIONREQUIRED struct {
	Data SseEventToolConfirmationRequiredData `json:"data"`
	// The event name.
...
type _EventTOOLCONFIRMATIONREQUIRED EventTOOLCONFIRMATIONREQUIRED
...
func NewEventTOOLCONFIRMATIONREQUIRED(data SseEventToolConfirmationRequiredData, event string) *EventTOOLCONFIRMATIONREQUIRED {
	this := EventTOOLCONFIRMATIONREQUIRED{}
	this.Data = data
	this.Event = event
	return &this
}
...
func (o *EventTOOLCONFIRMATIONREQUIRED) GetData() SseEventToolConfirmationRequiredData {
	if o == nil {
		var ret SseEventToolConfirmationRequiredData
		return ret
	}
...
func (o EventTOOLCONFIRMATIONREQUIRED) MarshalJSON() ([]byte, error) {
...
func (o EventTOOLCONFIRMATIONREQUIRED) ToMap() (map[string]interface{}, error) {
...
func (o *EventTOOLCONFIRMATIONREQUIRED) UnmarshalJSON(data []byte) (err error) {
	...
	varEventTOOLCONFIRMATIONREQUIRED := _EventTOOLCONFIRMATIONREQUIRED{}

	err = json.Unmarshal(data, &varEventTOOLCONFIRMATIONREQUIRED)

	if err != nil {
		return err
	}

	*o = EventTOOLCONFIRMATIONREQUIRED(varEventTOOLCONFIRMATIONREQUIRED)
...
type NullableEventTOOLCONFIRMATIONREQUIRED struct {
	value *EventTOOLCONFIRMATIONREQUIRED
	isSet bool
}

func (v NullableEventTOOLCONFIRMATIONREQUIRED) Get() *EventTOOLCONFIRMATIONREQUIRED {
	return v.value
}

func (v *NullableEventTOOLCONFIRMATIONREQUIRED) Set(val *EventTOOLCONFIRMATIONREQUIRED) {
	v.value = val
	v.isSet = true
}

func (v NullableEventTOOLCONFIRMATIONREQUIRED) IsSet() bool {
	return v.isSet
}

func (v *NullableEventTOOLCONFIRMATIONREQUIRED) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventTOOLCONFIRMATIONREQUIRED(val *EventTOOLCONFIRMATIONREQUIRED) *NullableEventTOOLCONFIRMATIONREQUIRED {
	return &NullableEventTOOLCONFIRMATIONREQUIRED{value: val, isSet: true}
}

func (v NullableEventTOOLCONFIRMATIONREQUIRED) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventTOOLCONFIRMATIONREQUIRED) UnmarshalJSON(src []byte) error {
	v.isSet = true
