...
// checks if the EventCONTEXTCOMPACTED type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventCONTEXTCOMPACTED{}

// EventCONTEXTCOMPACTED struct for EventCONTEXTCOMPACTED
type EventCONTEXTCOMPACTED struct {
	Data SseEventContextCompactedData `json:"data"`
	// The event name.
...
type _EventCONTEXTCOMPACTED EventCONTEXTCOMPACTED
...
func (o *EventCONTEXTCOMPACTED) GetData() SseEventContextCompactedData {
	if o == nil {
		var ret SseEventContextCompactedData
		return ret
	}
...
func (o EventCONTEXTCOMPACTED) MarshalJSON() ([]byte, error) {
...
func (o EventCONTEXTCOMPACTED) ToMap() (map[string]interface{}, error) {
...
func (o *EventCONTEXTCOMPACTED) UnmarshalJSON(data []byte) (err error) {
	...
	varEventCONTEXTCOMPACTED := _EventCONTEXTCOMPACTED{}

	err = json.Unmarshal(data, &varEventCONTEXTCOMPACTED)

	if err != nil {
		return err
	}

	*o = EventCONTEXTCOMPACTED(varEventCONTEXTCOMPACTED)
...
type NullableEventCONTEXTCOMPACTED struct {
	value *EventCONTEXTCOMPACTED
	isSet bool
}

func (v NullableEventCONTEXTCOMPACTED) Get() *EventCONTEXTCOMPACTED {
	return v.value
}

func (v *NullableEventCONTEXTCOMPACTED) Set(val *EventCONTEXTCOMPACTED) {
	v.value = val
	v.isSet = true
}

func (v NullableEventCONTEXTCOMPACTED) IsSet() bool {
	return v.isSet
}

func (v *NullableEventCONTEXTCOMPACTED) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventCONTEXTCOMPACTED(val *EventCONTEXTCOMPACTED) *NullableEventCONTEXTCOMPACTED {
	return &NullableEventCONTEXTCOMPACTED{value: val, isSet: true}
}

func (v NullableEventCONTEXTCOMPACTED) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventCONTEXTCOMPACTED) UnmarshalJSON(src []byte) error {
	v.isSet = true
