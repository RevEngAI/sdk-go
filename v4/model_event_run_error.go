...
// checks if the EventRUNERROR type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventRUNERROR{}

// EventRUNERROR struct for EventRUNERROR
type EventRUNERROR struct {
	Data SseEventRunErrorData `json:"data"`
	// The event name.
...
type _EventRUNERROR EventRUNERROR
...
func (o EventRUNERROR) MarshalJSON() ([]byte, error) {
...
func (o EventRUNERROR) ToMap() (map[string]interface{}, error) {
...
func (o *EventRUNERROR) UnmarshalJSON(data []byte) (err error) {
	...
	varEventRUNERROR := _EventRUNERROR{}

	err = json.Unmarshal(data, &varEventRUNERROR)

	if err != nil {
		return err
	}

	*o = EventRUNERROR(varEventRUNERROR)
...
type NullableEventRUNERROR struct {
	value *EventRUNERROR
	isSet bool
}

func (v NullableEventRUNERROR) Get() *EventRUNERROR {
	return v.value
}

func (v *NullableEventRUNERROR) Set(val *EventRUNERROR) {
	v.value = val
	v.isSet = true
}

func (v NullableEventRUNERROR) IsSet() bool {
	return v.isSet
}

func (v *NullableEventRUNERROR) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventRUNERROR(val *EventRUNERROR) *NullableEventRUNERROR {
	return &NullableEventRUNERROR{value: val, isSet: true}
}

func (v NullableEventRUNERROR) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventRUNERROR) UnmarshalJSON(src []byte) error {
	v.isSet = true
