...
type SecurityScanResult struct {
	...
	SecurityScan map[string]interface{} `json:"security_scan,omitempty"`
...
// SetSecurityScan gets a reference to the given map[string]interface{} and assigns it to the SecurityScan field.
