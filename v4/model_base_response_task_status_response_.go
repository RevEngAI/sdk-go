...
// checks if the BaseResponseTaskStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseResponseTaskStatusResponse{}

// BaseResponseTaskStatusResponse struct for BaseResponseTaskStatusResponse
type BaseResponseTaskStatusResponse struct {
	// Response status on whether the request succeeded
	Status *bool `json:"status,omitempty"`
	Data NullableTaskStatusResponse `json:"data,omitempty"`
...
type _BaseResponseTaskStatusResponse BaseResponseTaskStatusResponse
...
func NewBaseResponseTaskStatusResponse() *BaseResponseTaskStatusResponse {
	this := BaseResponseTaskStatusResponse{}
...
// SetData gets a reference to the given NullableTaskStatusResponse and assigns it to the Data field.
func (o *BaseResponseTaskStatusResponse) SetData(v TaskStatusResponse) {
	o.Data.Set(&v)
}
// SetDataNil sets the value for Data to be an explicit nil
func (o *BaseResponseTaskStatusResponse) SetDataNil() {
	o.Data.Set(nil)
}
...
func (o *BaseResponseTaskStatusResponse) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o BaseResponseTaskStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o BaseResponseTaskStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BaseResponseTaskStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varBaseResponseTaskStatusResponse := _BaseResponseTaskStatusResponse{}

	err = json.Unmarshal(data, &varBaseResponseTaskStatusResponse)

	if err != nil {
		return err
	}

	*o = BaseResponseTaskStatusResponse(varBaseResponseTaskStatusResponse)
...
type NullableBaseResponseTaskStatusResponse struct {
	value *BaseResponseTaskStatusResponse
	isSet bool
}

func (v NullableBaseResponseTaskStatusResponse) Get() *BaseResponseTaskStatusResponse {
	return v.value
}

func (v *NullableBaseResponseTaskStatusResponse) Set(val *BaseResponseTaskStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseResponseTaskStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseResponseTaskStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseResponseTaskStatusResponse(val *BaseResponseTaskStatusResponse) *NullableBaseResponseTaskStatusResponse {
	return &NullableBaseResponseTaskStatusResponse{value: val, isSet: true}
}

func (v NullableBaseResponseTaskStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseResponseTaskStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
