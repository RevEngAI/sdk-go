...
// checks if the SseEventToolConfirmationRequiredData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SseEventToolConfirmationRequiredData{}

// SseEventToolConfirmationRequiredData struct for SseEventToolConfirmationRequiredData
type SseEventToolConfirmationRequiredData struct {
...
type _SseEventToolConfirmationRequiredData SseEventToolConfirmationRequiredData
...
func NewSseEventToolConfirmationRequiredData(data interface{}, eventId int64, type_ string) *SseEventToolConfirmationRequiredData {
	this := SseEventToolConfirmationRequiredData{}
	this.Data = data
...
func (o SseEventToolConfirmationRequiredData) MarshalJSON() ([]byte, error) {
...
func (o SseEventToolConfirmationRequiredData) ToMap() (map[string]interface{}, error) {
...
func (o *SseEventToolConfirmationRequiredData) UnmarshalJSON(data []byte) (err error) {
	...
	varSseEventToolConfirmationRequiredData := _SseEventToolConfirmationRequiredData{}

	err = json.Unmarshal(data, &varSseEventToolConfirmationRequiredData)

	if err != nil {
		return err
	}

	*o = SseEventToolConfirmationRequiredData(varSseEventToolConfirmationRequiredData)
...
type NullableSseEventToolConfirmationRequiredData struct {
	value *SseEventToolConfirmationRequiredData
	isSet bool
}

func (v NullableSseEventToolConfirmationRequiredData) Get() *SseEventToolConfirmationRequiredData {
	return v.value
}

func (v *NullableSseEventToolConfirmationRequiredData) Set(val *SseEventToolConfirmationRequiredData) {
	v.value = val
	v.isSet = true
}

func (v NullableSseEventToolConfirmationRequiredData) IsSet() bool {
	return v.isSet
}

func (v *NullableSseEventToolConfirmationRequiredData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSseEventToolConfirmationRequiredData(val *SseEventToolConfirmationRequiredData) *NullableSseEventToolConfirmationRequiredData {
	return &NullableSseEventToolConfirmationRequiredData{value: val, isSet: true}
}

func (v NullableSseEventToolConfirmationRequiredData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSseEventToolConfirmationRequiredData) UnmarshalJSON(src []byte) error {
	v.isSet = true
