...
// checks if the OperationMetadataRemediationResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OperationMetadataRemediationResult{}

// OperationMetadataRemediationResult struct for OperationMetadataRemediationResult
type OperationMetadataRemediationResult struct {
	...
	Response *RemediationResult `json:"response,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OperationMetadataRemediationResult OperationMetadataRemediationResult
...
func NewOperationMetadataRemediationResult(done bool, name string) *OperationMetadataRemediationResult {
	this := OperationMetadataRemediationResult{}
	this.Done = done
	this.Name = name
	return &this
}
...
// SetResponse gets a reference to the given RemediationResult and assigns it to the Response field.
func (o *OperationMetadataRemediationResult) SetResponse(v RemediationResult) {
	o.Response = &v
}

func (o OperationMetadataRemediationResult) MarshalJSON() ([]byte, error) {
...
func (o OperationMetadataRemediationResult) ToMap() (map[string]interface{}, error) {
...
func (o *OperationMetadataRemediationResult) UnmarshalJSON(data []byte) (err error) {
	...
	varOperationMetadataRemediationResult := _OperationMetadataRemediationResult{}

	err = json.Unmarshal(data, &varOperationMetadataRemediationResult)

	if err != nil {
		return err
	}

	*o = OperationMetadataRemediationResult(varOperationMetadataRemediationResult)
...
type NullableOperationMetadataRemediationResult struct {
	value *OperationMetadataRemediationResult
	isSet bool
}

func (v NullableOperationMetadataRemediationResult) Get() *OperationMetadataRemediationResult {
	return v.value
}

func (v *NullableOperationMetadataRemediationResult) Set(val *OperationMetadataRemediationResult) {
	v.value = val
	v.isSet = true
}

func (v NullableOperationMetadataRemediationResult) IsSet() bool {
	return v.isSet
}

func (v *NullableOperationMetadataRemediationResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOperationMetadataRemediationResult(val *OperationMetadataRemediationResult) *NullableOperationMetadataRemediationResult {
	return &NullableOperationMetadataRemediationResult{value: val, isSet: true}
}

func (v NullableOperationMetadataRemediationResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOperationMetadataRemediationResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
