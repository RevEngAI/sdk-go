...
// checks if the BaseDataType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BaseDataType{}

// BaseDataType struct for BaseDataType
...
func (o BaseDataType) MarshalJSON() ([]byte, error) {
...
func (o BaseDataType) ToMap() (map[string]interface{}, error) {
...
func (o *BaseDataType) UnmarshalJSON(data []byte) (err error) {
...
type NullableBaseDataType struct {
	value *BaseDataType
	isSet bool
}

func (v NullableBaseDataType) Get() *BaseDataType {
	return v.value
}

func (v *NullableBaseDataType) Set(val *BaseDataType) {
	v.value = val
	v.isSet = true
}

func (v NullableBaseDataType) IsSet() bool {
	return v.isSet
}

func (v *NullableBaseDataType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBaseDataType(val *BaseDataType) *NullableBaseDataType {
	return &NullableBaseDataType{value: val, isSet: true}
}

func (v NullableBaseDataType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBaseDataType) UnmarshalJSON(src []byte) error {
	v.isSet = true
